        ...
        textToSpeech = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    textToSpeech.speak("say read for read, Location for location, Weather for weather, calculator for calculator, Time and date for date and time, Battery for Battery. say exit to close the application.  Swipe right and say what you want ", TextToSpeech.QUEUE_FLUSH, null);
                }
            }
        });
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                if (mVoiceInputTv.getText().toString().equals("time and date") ||
                        mVoiceInputTv.getText().toString().equals("date and time")) {
